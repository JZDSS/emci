...
class PoseLoss(nn.Module):
    ...
    def __init__(self, max_w1, min_w1, max_epsilon1, min_epsilon1,
        ...
        self.mean = torch.from_numpy(np.mean(aligned, axis=0, keepdims=True))
    ...
    def forward(self, predictions, targets):
        ...
        tmp = targets.view(-1, 106, 2) - self.mean()
        ...
        for i in range(targets.shape[0]):
            ...
            loss += self.dwing2(predictions. targets, w1, epsilon1, w2, epsilon2)
